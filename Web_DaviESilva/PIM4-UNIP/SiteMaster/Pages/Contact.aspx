<%@ Page Title="Contato" Language="C#" MasterPageFile="~/UnloggedSite.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="SiteMaster.Contact" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form name="Contact" action="#" method="post">
        ...
        <input type="email" id="txtEmail" name="txtEmail" placeholder="Digite seu e-mail!"/><br /><br />
