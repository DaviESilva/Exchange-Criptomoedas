<%@ Page Title="Bitcoin" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BitcoinPage.aspx.cs" Inherits="SiteMaster.Pages.Crypto.BitcoinPage" %>
        ...
        <tr>
            <td>
                <div class="blue-container">
                    <img class="image-crypto" src="/images/bitcoin_logo_icon_147311.png" alt="Logo da Criptomoeda" />
                    <div class="title-crypto">
                        BITCOIN<br>
                        BTC<br>
                    </div>
                    <div class="prices">
                        <label for="">R$100.151,83 BRL</label>
                        <br />
                        <label for="">$18.847,74 USD</label>
                    </div>
                </div>
            </td>
            <td>
