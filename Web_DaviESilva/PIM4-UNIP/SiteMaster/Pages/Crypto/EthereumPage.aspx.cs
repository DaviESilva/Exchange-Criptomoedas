...
{
    public partial class EthereumPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Write(WalletBalance1.Text = Convert.ToString(userData.ethValue));
                Response.Write(WalletBalance2.Text = Convert.ToString(userData.ethValue));
        ...
        protected void BuySend_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                userData.ethValue = userData.ethValue + userInputBuy;
        ...
        protected void SellSend_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (userInputSell <= userData.ethValue)
                {
                    userData.ethValue = userData.ethValue - userInputSell;
