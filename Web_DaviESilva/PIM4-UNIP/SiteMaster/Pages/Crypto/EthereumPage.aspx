<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EthereumPage.aspx.cs" Inherits="SiteMaster.Pages.Crypto.EthereumPage" %>
        ...
        <tr>
            <td>
                <div class="blue-container">
                    <img class="image-crypto" src="/images/ethereum.png" alt="Logo da Criptomoeda" />
                    <div class="title-crypto">
                        ETHEREUM<br>
                        ETH<br>
                    </div>
                    <div class="prices">
                        <label for="">R$2.086,05 BRL</label>
                        <br />
                        <label for="">$387.97 USD</label>
                    </div>
                </div>
            </td>
            <td>
