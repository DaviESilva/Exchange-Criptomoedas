<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="XRPPage.aspx.cs" Inherits="SiteMaster.Pages.Crypto.XRPPage" %>
        ...
        <tr>
            <td>
                <div class="blue-container">
                    <img class="image-crypto" src="/images/xrp_cryptocurrency_logo_icon_131379.png" alt="Logo da Criptomoeda" />
                    <div class="title-crypto">
                        XRP<br>
                        XRP<br>
                    </div>
                    <div class="prices">
                        <label for="">R$1,04 BRL</label>
                        <br />
                        <label for="">$0.19 USD</label>
                    </div>
                </div>
            </td>
            <td>
