<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DogecoinPage.aspx.cs" Inherits="SiteMaster.Pages.Crypto.DogecoinPage" %>
        ...
        <tr>
            <td>
                <div class="blue-container">
                    <img class="image-crypto" src="/images/doge.png" alt="Logo da Criptomoeda" />
                    <div class="title-crypto">
                        DOGECOIN<br>
                        DOGE<br>
                    </div>
                    <div class="prices">
                        <label for="">R$0,01 BRL</label>
                        <br />
                        <label for="">$0,00 USD</label>
                    </div>
                </div>
            </td>
            <td>
