...
{
    public partial class DogecoinPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Write(WalletBalance1.Text = Convert.ToString(userData.dogeValue));
                Response.Write(WalletBalance2.Text = Convert.ToString(userData.dogeValue));
