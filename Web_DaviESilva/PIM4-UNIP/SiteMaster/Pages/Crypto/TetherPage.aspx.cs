...
{
    public partial class TetherPage : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Response.Write(WalletBalance1.Text = Convert.ToString(userData.usdtValue));
                Response.Write(WalletBalance2.Text = Convert.ToString(userData.usdtValue));
        ...
        protected void BuySend_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                userData.usdtValue = userData.usdtValue + userInputBuy;
        ...
        protected void SellSend_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (userInputSell <= userData.usdtValue)
                {
                    userData.usdtValue = userData.usdtValue - userInputSell;
